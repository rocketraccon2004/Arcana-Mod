...
import static net.arcanamod.aspects.ColourRange.create;
...
public class Aspects {
    ...
    public static final Aspect
            ...
            DUMMY = Aspect.create("dummy", ColourRange.create(0x0, 0x0, 0x0, 0x0, 0x0), null),
    ...
    public static void init() {
        Arcana.logger.info("Arcana: Aspects Initialized");
    }
}
